// DLS General 2.0
var members = document.getElementById("p2").innerHTML;
var membersArray;
var spans;
document.getElementById("p1").innerHTML = "";
document.getElementById("p2").innerHTML = "";
document.querySelector("h1:first-child").innerHTML = "";
...
for(var i=0;i<spans.length;i++){
    document.getElementsByTagName("h1")[2].style.textShadow = "rgb(025, 025, 025) -4px 1px 4px, rgba(025, 025, 025, 0.9) 3px -9px 9px, rgba(025, 025, 025, 0.9) 3px 1px 3px";
    document.getElementsByTagName("h1")[2].style.color = "white";
    document.getElementsByTagName("h1")[2].style.fontFamily = "Arial";
    document.getElementsByTagName("h1")[2].style.fontSize = "44px";
...
document.body.style.background = "url('https://media.giphy.com/media/2A75RyXVzzSI2bx4Gj/giphy.gif')";
